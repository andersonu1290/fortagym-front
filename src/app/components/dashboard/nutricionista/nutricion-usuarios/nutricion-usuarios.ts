...
@Component({
  selector: 'app-nutricionista-usuarios',
  standalone: true,
  imports: [CommonModule, RouterModule, FilterPendientesPipe], // Agregado el Pipe
  templateUrl: './nutricion-usuarios.html',
  styleUrl: './nutricion-usuarios.scss'
})
export class NutricionistaUsuarios implements OnInit {
